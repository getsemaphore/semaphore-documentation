...
We've significantly expanded our data model to provide more comprehensive company information:
...
- **Status Details (Beta)** <Icon icon="info-circle" color="#EF4444" /> - We're introducing `statusDetailsBeta`, which provides enriched information about company status changes, including closure reasons, liquidation details, and important dates. As this feature is in beta, we're actively collecting feedback to refine the data structure and ensure it meets your needs.

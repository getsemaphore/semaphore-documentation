...
- **🇵🇱 Poland Support Launch** - Full support for Polish entities with CEIDG and KRS registry integration
...
- **Fixed document retrieval and listing** (Spain) - Resolved deployment issue affecting Spanish document access
- **Improved parsing of activities** (Both) - Enhanced extraction and processing for better accuracy

...
- **Initial support for Norway** - We're excited to announce support for Norwegian companies! Currently available data point:
  - `companyProfile` - Access basic company information, legal representatives, other key peoples and establishments from the Norwegian Business Register (Brønnøysundregistrene)
